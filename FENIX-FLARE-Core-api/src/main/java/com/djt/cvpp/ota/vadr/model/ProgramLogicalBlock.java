 ...
 *
 */
public class ProgramLogicalBlock extends AbstractEntity {
    ...
    private ProgramLogicalBlock() {
    }

    private ProgramLogicalBlock(ProgramLogicalBlockBuilder builder) {
    ...
    public static final class ProgramLogicalBlockBuilder {
        ...
        public ProgramLogicalBlockBuilder() {
        }

        public ProgramLogicalBlockBuilder withPersistentIdentity(Long persistentIdentity) {
            this.persistentIdentity = persistentIdentity;
            return this;
        }

        public ProgramLogicalBlockBuilder withParentBinaryMetadata(BinaryMetadata parentBinaryMetadata) {
            this.parentBinaryMetadata = parentBinaryMetadata;
            return this;
        }

        public ProgramLogicalBlockBuilder withStartAddress(String startAddress) {
            this.startAddress = startAddress;
            return this;
        }

        public ProgramLogicalBlockBuilder withLength(String length) {
            this.length = length;
            return this;
        }

        public ProgramLogicalBlock build() {
            return new ProgramLogicalBlock(this);
        }
    }
}
